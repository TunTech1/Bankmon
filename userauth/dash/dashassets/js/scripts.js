...
$(document).ready(function() {
    ...
    function qp_required_misc() {
        ...
        $('.card-header').each(function() {
            ...
            if (thisHeader.height() > 40) {
                thisHeader.find('.header-btn-block').css({
                    'top': '31px'
                });
            }
        });
        ...
        $(document).on('click', 'button.hamburger', function(e) {
            ...
            $('.sidebar-horizontal.fixed-top').css({
        ...
        if ($('.dropdown-menu-fullscreen').length) {
            ...
            $('.dropdown-menu-fullscreen').closest('.nav-item').css({
                'position': 'static'
            });
        ...
        if ($(chartID).length) {
            ...
            function load_chart(range, xAxisLabels, dataSet1, dataSet2) {
                ...
                if (canvasParent.closest('.card').hasClass('card-sm')) {
                    ...
                    chartHeight = 82;
                    canvasParent.closest('.card-body').css({
                        'padding-left': '0',
                        'padding-right': '0'
                    });
        ...
        if ($(placeholder).length) {
            ...
            $(".assign-task").on("click", function() {
                ...
                if (taskTitle == "") {
                    ...
                    taskManagerTaskList.find(".task-list-item").first().delay(200).animate({
                        "opacity": "1"
                    }, 300, function() {
        ...
        if ($(calendarContainer).length) {
            ...
            $("#add-available-event").on("click", function() {
                ...
                if (eventName != "") {
                    ...
                    $(this).closest(".calendar-controls").find(".available-events .fc-event").first().delay(200).animate({
                        "opacity": "1"
                    }, 300);
    ...
    function qp_mailbox_message_compose() {
        ...
        if (placeholder.length) {
            ...
            $("input.tt-input, input.tt-hint").css({
                "width": "auto"
            });
